        ...
        if pretrained:
            ...
            try:
                ...
                if os.path.exists(model_path):
                    ...
                    # NOTE: use dist_utils guards so single-process eval works.
                    ...
                    # Wait for rank0 download to finish (no-op if not distributed)
                    dist_utils.barrier()
                    # On non-main ranks (or if rank0 returned in-memory dict),
                    # load from the file that was downloaded to disk.
